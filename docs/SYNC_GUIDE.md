...
4. **重建分支**：以上游最新 commit 为基线新建 `sync-build` 分支（干净官方代码），
 再从 `main` 恢复本仓专属文件（`.github/`、`patches/`、`docs/`、`README.md`、`README_zh-CN.md`、`CHANGELOG.md`、`LAST_SYNC`）；
...
git checkout -B sync-build FETCH_HEAD
  git checkout main -- .github patches docs README.md README_zh-CN.md CHANGELOG.md LICENSE LAST_SYNC
